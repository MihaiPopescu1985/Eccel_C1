...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ADD_NEW_WORKER`(IN fName VARCHAR(20), IN lName VARCHAR(20), IN cardNo VARCHAR(20), IN pos VARCHAR(20), IN nick VARCHAR(20), IN pass VARCHAR(20), IN accLvl TINYINT)
BEGIN
...
VALUES (fName, lName, cardNo, pos, 0, nick, pass, accLvl); 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
